module.exports = {
    ...
    // Instagram Account
    "instagram_username": "contact@vastknight.vision", // without @
    "instagram_password": "Flom@ster90",
    "instagram_hashtag": ["weed", "sport", "funny"], // without #, recommended more than 20
    ...
    "comment_mode": {
        "comments": {
            "type": "array",
            "source": ["hahaha you are awesome", "I think i have seen you before", "Hey you are amazing you know this right?"],
        }
    },
