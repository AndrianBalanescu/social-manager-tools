module.exports = {
    ...
    "instagram_hashtag": ["ufc", "mma", "fighter"], // without #, recommended more than 20
    ...
    "bot_mode": "comment_mode",
    "bot_likeday_min": 250, // work in all likemode_*
    ...
    "bot_followday": 200, // number of follow-defollow user/day, work in fdfmode_classic. In 2018 limit instagram is 500/day
    ...
    "comment_mode": {
        "comments": {
            "type": "array",
            "source": ["You are awesome", "Hey how are you so cool?", "Love is in the air"],
        }
    },
